			...
			<div class="blog">
				<div class="blog-post-wrap">
					...
					<div class="blog-post">
						...
						<p>I constantly have to go back and search for snippets of code whenever I encounter a problem building a site. This can be frustrating especially when I know that I have already solved that very same issue at some prior point in time. As a result I have decided it is time to add a […]</p>
					...
					<div class="blog-post">
						<div class="blog-head-banner">
							<a class="name-post-blog" href="single-post.php">Helpful Things to know about Contact Forms</a>
							<a class="blog-post-reply-count" href="#"><p>0</p><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve"><g><path d="M47.964 8.127H16.036c-4.4 0-8 3.6-8 8v20.977c0 4.4 3.6 8 8 8h7.397v10.768l13.333-10.768h11.197c4.4 0 8-3.6 8-8V16.127 C55.964 11.7 52.4 8.1 48 8.127z M50.964 37.104c0 1.626-1.374 3-3 3H36.767H35l-1.375 1.11l-5.191 4.193v-0.303v-5h-5 h-7.397c-1.626 0-3-1.374-3-3V16.127c0-1.626 1.374-3 3-3h31.928c1.626 0 3 1.4 3 3V37.104z"/><circle cx="21.7" cy="26.6" r="2.9"/><circle cx="32" cy="26.6" r="2.9"/><circle cx="42.3" cy="26.6" r="2.9"/></g></svg></a>
						</div>
						<p>I was redesigning the contact portion of my portfolio site today, and as per usual spent quite a bit of time googling and searching things to get the form jusssst right.  Here are a few of the things I incorporated into the final product:   1.  Placeholder Text It’s fairly simple to add placeholder text [...]</p>
						<div class="blog-post-meta">
							<a href="single-post.php">
								<h5>( Read On... )</h5>
							</a>
					...
					<div class="blog-post">
						<div class="blog-head-banner">
							<a class="name-post-blog" href="single-post.php">A Small (but Incredibly Handy) Sublime Text Setting</a>
							<a class="blog-post-reply-count" href="#"><p>0</p><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve"><g><path d="M47.964 8.127H16.036c-4.4 0-8 3.6-8 8v20.977c0 4.4 3.6 8 8 8h7.397v10.768l13.333-10.768h11.197c4.4 0 8-3.6 8-8V16.127 C55.964 11.7 52.4 8.1 48 8.127z M50.964 37.104c0 1.626-1.374 3-3 3H36.767H35l-1.375 1.11l-5.191 4.193v-0.303v-5h-5 h-7.397c-1.626 0-3-1.374-3-3V16.127c0-1.626 1.374-3 3-3h31.928c1.626 0 3 1.4 3 3V37.104z"/><circle cx="21.7" cy="26.6" r="2.9"/><circle cx="32" cy="26.6" r="2.9"/><circle cx="42.3" cy="26.6" r="2.9"/></g></svg></a>
						</div>
						<p>A handy little setting in Sublime Text that I encourage everyone to use is: “save_on_focus_lost”: true, Save this little block of code in the user-settings and from then on when you switch windows from Sublime Text to something else like Chrome, Sublime automatically saves your files.</p>
						<div class="blog-post-meta">
							<a href="single-post.php">
								<h5>( Read On... )</h5>
							</a>
					...
					<div class="blog-post">
						...
						<p>Recently I got Premium WordPress Hosting with MediaTemple.  I have been working on a site for several months now and decided that I would need to have a host that could be more accessible to me in my times of need.  I use WebHosting For Students for my portfolio and have no complaints but I […]</p>
						<div class="blog-post-meta">
							<a href="single-post.php">
								<h5>( Read On... )</h5>
							</a>
					...
					<div class="blog-post">
						<div class="blog-head-banner">
							<a class="name-post-blog" href="single-post.php">Web Fundamentals</a>
							<a class="blog-post-reply-count" href="#"><p>0</p><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve"><g><path d="M47.964 8.127H16.036c-4.4 0-8 3.6-8 8v20.977c0 4.4 3.6 8 8 8h7.397v10.768l13.333-10.768h11.197c4.4 0 8-3.6 8-8V16.127 C55.964 11.7 52.4 8.1 48 8.127z M50.964 37.104c0 1.626-1.374 3-3 3H36.767H35l-1.375 1.11l-5.191 4.193v-0.303v-5h-5 h-7.397c-1.626 0-3-1.374-3-3V16.127c0-1.626 1.374-3 3-3h31.928c1.626 0 3 1.4 3 3V37.104z"/><circle cx="21.7" cy="26.6" r="2.9"/><circle cx="32" cy="26.6" r="2.9"/><circle cx="42.3" cy="26.6" r="2.9"/></g></svg></a>
						</div>
						<p>I recently spent some time designing a new database site.  I had a lot of fun with it and was able to really strengthen my Photoshop skills in particular.  I noticed, now that I have coded several designs, things seem to come more naturally for me as well as being more efficiently written.  Being that […]</p>
						<div class="blog-post-meta">
							<a href="single-post.php">
								<h5>( Read On... )</h5>
							</a>
					...
					<div class="blog-post">
						<div class="blog-head-banner">
							<a class="name-post-blog" href="single-post.php">It’s OK to Take a Break</a>
							<a class="blog-post-reply-count" href="#"><p>0</p><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve"><g><path d="M47.964 8.127H16.036c-4.4 0-8 3.6-8 8v20.977c0 4.4 3.6 8 8 8h7.397v10.768l13.333-10.768h11.197c4.4 0 8-3.6 8-8V16.127 C55.964 11.7 52.4 8.1 48 8.127z M50.964 37.104c0 1.626-1.374 3-3 3H36.767H35l-1.375 1.11l-5.191 4.193v-0.303v-5h-5 h-7.397c-1.626 0-3-1.374-3-3V16.127c0-1.626 1.374-3 3-3h31.928c1.626 0 3 1.4 3 3V37.104z"/><circle cx="21.7" cy="26.6" r="2.9"/><circle cx="32" cy="26.6" r="2.9"/><circle cx="42.3" cy="26.6" r="2.9"/></g></svg></a>
						</div>
						<p>This evening on my way to work my car broke down which is a first for me.  Smoke came flooding out from under the dashboard and the car turned off while I was at a red light only a few minutes away from the hotel (where I work).  Now my first instinct was to allow […]</p>
						<div class="blog-post-meta">
							<a href="single-post.php">
								<h5>( Read On... )</h5>
							</a>
