...
<?php include("parts/doctype.php"); ?>
	...
	<body>
		...
		<div class="main-container">
			...
			<section class="portfolio-wrap single">
				<article class="work">
					<div class="wrapper">
						<h2>Recent Work:</h2>
					</div>  <!-- .wrapper -->
