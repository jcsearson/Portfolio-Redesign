	...
	<body>
		...
		<div class="main-container bio-landing">
			...
			<h2>Front End Developer</h2>
				<div class="cont-about biography-landing">
					<div class="wrapper">
						<div class="thoughts">
			...
			<div class="bio-wrapper">
				<div class="biography">
					...
					<div class="logo">
						<span>
							<img src="images/content/james.png" alt="Photo of James C. Searson">
						</span>
					</div>
			...
			<section class="contact-form">
				<h2 class="strikethrough"><span>Contact Me</span></h2>
				...
				<div class="my-social">
					<ul class="foot-social">
						...
						<li class="foot-list-item"><a href="#">
